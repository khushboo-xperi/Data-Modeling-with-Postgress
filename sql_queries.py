...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id varchar, start_time timestamp, user_id int, level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent text);")
...
song_table_create = ("CREATE TABLE IF NOT EXISTS songs (song_id char, title varchar, artist_id varchar, year int, duration numeric);")
